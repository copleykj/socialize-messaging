...
export default ({ Meteor, BaseModel, User, ServerTime, ConversationsCollection,
    Participant, ParticipantsCollection, Message, MessagesCollection }) => {
    /**
    ...
    class Conversation extends BaseModel {
        ...
        */
        participantsAsUsers(options = {}) {
            const participantIds = this.participants({ fields: { userId: 1 } }).map(participant => participant.userId);
